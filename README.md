...
```bash
git clone https://[github.com/AnjaniRaman/Banking-Operations-Compliance-Dashboard.git](https://github.com/AnjaniRaman/PowerBI-Banking-Operations-Compliance_Dashboard)
```
